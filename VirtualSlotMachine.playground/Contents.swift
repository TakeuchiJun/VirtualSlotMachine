...
class VirtualSlotMachie {
    ...
    var dictWinHistory:[Int:Int] = [:]  //当たり履歴格納用
    ...
    func slotStart(){
        ...
        guard yourManey > 99, yourManey < 10001 else {
